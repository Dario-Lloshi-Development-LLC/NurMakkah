  ...
  const content = (
    ...
    >
      ...
      <View style={styles.settingContent}>
        <Text
          style={[styles.settingTitle, { textAlign: isRTL ? "right" : "left" }]}
        >
          {title}
        </Text>
        {subtitle && (
...
const SettingsScreen: React.FC = () => {
  ...
  const loc = (texts: any) =>
    getLocalizedTextWithFallback(texts, settings as any);
      ...
      >
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.card}>
            <SettingItem
              ...
              subtitle={loc({
                albanian: "Zgjidhni gjuhën e aplikacionit",
                arabic: "اختر لغة التطبيق",
            ...
            <SettingItem
              title={loc({
                albanian: "Madhësia e Shkrimit",
                arabic: "حجم الخط",
                english: "Font Size",
              })}
              subtitle={loc({
                albanian: "Rregullo madhësinë e tekstit",
                arabic: "ضبط حجم النص",
                english: "Adjust text size",
              })}
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.card}>
            <SettingItem
              title={loc({
                albanian: "Shfaq Arabishten",
                arabic: "عرض النص العربي",
                english: "Show Arabic Text",
              })}
              value={settings.showArabicText}
              onValueChange={(value) =>
                handleSettingChange("showArabicText", value)
              }
              type="toggle"
              icon="translate"
              settings={settings}
            ...
            <SettingItem
              ...
              onValueChange={(value) =>
                handleSettingChange("showTransliteration", value)
              }
              type="toggle"
              icon="text-fields"
              settings={settings}
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.card}>
            <SettingItem
              title={loc({
                albanian: "Rreth Nur Makkah",
                arabic: "حول نور مكة",
                english: "About Nur Makkah",
              })}
              value={null}
